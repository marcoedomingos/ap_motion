...
export const ReelsCarousel: React.FC<ReelsCarouselProps> = ({
  ...
  return (
    <section id="reels" className="relative py-10 sm:py-14 overflow-hidden border-b border-white/10 bg-black text-white">
          ...
          <div className="flex items-center gap-2 self-start sm:self-auto">
            <button
              ...
              className={`w-9 h-9 rounded-full border flex items-center justify-center transition-all cursor-pointer ${
                canScrollLeft
                  ? 'border-white/20 bg-zinc-900 text-white hover:bg-zinc-800 hover:border-white/40 shadow-sm active:scale-95'
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  className="relative w-[210px] sm:w-[240px] md:w-[250px] aspect-[9/16] rounded-2xl overflow-hidden bg-zinc-950 border border-white/10 group-hover:border-white/40 transition-all duration-300 shadow-sm group-hover:shadow-2xl"
                >
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none bg-black/40">
                    <div className="w-11 h-11 rounded-full bg-black/70 backdrop-blur-md border border-white/30 flex items-center justify-center text-white shadow-xl group-hover:scale-110 transition-transform">
                ...
                <div className="w-[210px] sm:w-[240px] md:w-[250px] px-0.5">
                  <div className="flex items-center justify-between text-xs text-zinc-400 mb-0.5 font-mono">
                    <span className="font-medium text-zinc-300 truncate">{project.client || 'AP Motion'}</span>
                    {project.duration && (
                      <span className="text-[11px] shrink-0 text-zinc-500">{project.duration}</span>
                    )}
                  </div>
                  <h3 className="text-xs sm:text-sm font-semibold text-white line-clamp-1 group-hover:text-zinc-300 transition-colors">
                    {project.title}
                  </h3>
                </div>
              </div>
